...
clear;
%%% 画小圆的r
% net_small：小圆，不固定；fix_small:小圆，固定
...
% bubblesize([20 50])
bubblesize([15 45])
% hl20 = legend('r^{AW}','FontName','Times New Roman','FontSize',40);
% set(hl20,'Box','on');
grid on;
...
% set(h,'Position', [0.41 0.40 0.022 0.5]);  %设置colorbar位置
...
% title('(b) RCDPR','fontsize',40,'position',[2,1.0])
% xtickangle(45);
