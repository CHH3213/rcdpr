...
public: void OnRosMsg0(const std_msgs::Float32MultiArrayConstPtr &_msg)
{
  ...
  if (this->world->SimTime() - this->prevtime >= this->timeinterval||this->world->SimTime() - this->prevtime<0)
  {
    ...
    // 直接传入uav位置：（x,y,z)
    this->bot_position4 = ignition::math::Vector3d(_msg->data[7],_msg->data[8],_msg->data[9]);
    this->bot_position5 = ignition::math::Vector3d(_msg->data[10],_msg->data[11],_msg->data[12]);
    this->bot_position6 = ignition::math::Vector3d(_msg->data[13],_msg->data[14],_msg->data[15]);
    this->bot_position7 = ignition::math::Vector3d(_msg->data[16],_msg->data[17],_msg->data[18]);
...
private: void QueueThread()
{
  ...
  private:
    ...
    //parameters of 8 cable nodes' position
      ...
      double const posx1=0.0, posy1=0.0,posz1=-0.0;//对应ugv1
