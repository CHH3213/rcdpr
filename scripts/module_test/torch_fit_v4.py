...
# -*-coding:utf-8-*-
# @Project: ugv_uav
# @File: torch_fit_value2.py---使用torch 神经网络对函数拟合求梯度
# @Author: CHH
...
if __name__ == '__main__':
    ...
    if train == True:
        ...
        if random_data == False:
            ...
            # print(np.shape(train_x))
            # sio.savemat('/home/chh3213/ros_wc/src/plan_cdpr/scripts/data' + '/v2_data.mat',
            #             {'train_x': train_x, 'train_y': train_y})
            # print('处理完毕')
            # print('train_x ', train_x)
            # print('train_y ', train_y)

            train_data = sio.loadmat('/home/chh3213/ros_wc/src/plan_cdpr/scripts/data/v2_data.mat')
        ...
        # optimizer 优化
        if os.path.exists('/home/chh3213/ros_wc/src/plan_cdpr/scripts/model/torch_fit_value2.pt'):
            print('load model!!!')
            print('**********************')
            net = torch.load('/home/chh3213/ros_wc/src/plan_cdpr/scripts/model/torch_fit_value2.pt')
        optimizer = torch.optim.SGD(net.parameters(), lr=1e-4,momentum=0.5,weight_decay=0.001)
        ...
        for i in range(epoches):
            ...
            if i % 50 == 0:
                ...
                torch.save(net, '/home/chh3213/ros_wc/src/plan_cdpr/scripts/model/torch_fit_value2.pt')
        '''++++++++++++++++++++++++++++++'''
        ...
        # TODO: 拟合 closestDistanceBetweenLines（）
        # x = np.random.random((128, 2)) * 6 - 3

        # x = np.arange(start=-3., stop=3., step= 0.01)
        # x = np.reshape(x, (len(x),1))
        # param_var = np.random.random((128, 6)) * 3
